...
<table style={TableStyle.table}>
  ...
  <tbody>
    <tr style={TableStyle.tr}>
      ...
      <td style={TableStyle.td}>DID表示切替</td>
      <td style={TableStyle.td}>グローバル</td>
    </tr>
    <tr style={TableStyle.tr}>
      <td style={TableStyle.td}><code>L</code></td>
    ...
    <tr style={TableStyle.tr}>
      <td style={TableStyle.td}><code>W</code></td>
      <td style={TableStyle.td}>天気予報クリックモード</td>
      <td style={TableStyle.td}>グローバル</td>
    </tr>
    <tr style={TableStyle.tr}>
      <td style={TableStyle.td}><code>C</code></td>
      <td style={TableStyle.td}>雨雲レーダー表示</td>
      <td style={TableStyle.td}>グローバル</td>
    </tr>
    <tr style={TableStyle.tr}>
    ...
    <tr>
      ...
      <td style={TableStyle.td}>描画/選択のキャンセル、天気ポップアップ閉じる</td>
      <td style={TableStyle.td}>グローバル/DrawingTools</td>
    </tr>
  </tbody>
</table>
