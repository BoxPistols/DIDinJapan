...
- [Turf.js booleanPointInPolygon](https://turfjs.org/docs/#booleanPointInPolygon) - 点の包含判定
- [Turf.js lineIntersect](https://turfjs.org/docs/#lineIntersect) - ライン交差判定
- [Turf.js intersect](https://turfjs.org/docs/#intersect) - ポリゴン交差計算
